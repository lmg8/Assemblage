...
e.changeSecondaryFontColor("white", "#C594C5");
e.changeHeaderButtonColor("#eaeaea", "#FAC863")

e.changeBackgroundColor("#667188")
e.changeFolderBackgroundColor("#36485d");
e.changeFolderButtonColor("#a9e9a4", "white")
e.changeFolderFontColor("white");
...
if (e.getFolders() === null) {
    ...
    e.reAssemblage({title: "Developer Title", width:"500px", position:"right"}, exampleFoldersList)

} else {
    e.reAssemblage({title: "Developer Title", width:"500px", position:"right"}, e.getFolders())
}
